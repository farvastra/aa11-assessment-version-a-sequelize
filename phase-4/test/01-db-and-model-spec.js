...
const { resetDB, seedDBFile } = require("../../test-utils/test-utils");
const {
  Entree,
  EntreeType,
  Ingredient,
...
sequelize.models = { Entree, EntreeType, Ingredient, EntreeIngredient };
    ...
    it("implements the correct association from Entree to EntreeType", async () => {
      try {
        const steakEntree = await Entree.findOne({
          ...
          include: [{ model: EntreeType, as: "EntreeType" }],
        });
